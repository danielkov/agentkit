...
| [`agentkit-provider-baseten`](https://github.com/danielkov/agentkit/tree/main/crates/agentkit-provider-baseten)       | [Baseten](https://www.baseten.co)      | Bearer                  | `inference.baseten.co/v1/chat/completions` |
